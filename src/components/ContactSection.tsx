...
export default function ContactSection() {
    return (
        <section id="contact" className="py-24 bg-[#083524] relative overflow-hidden">
            <FlickeringGrid
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-start">
                    ...
                    <div className="w-full p-6 md:p-8 rounded-2xl border border-white/20" style={{ backgroundColor: 'rgba(255, 255, 255, 0.08)', backdropFilter: 'blur(10px)' }}>
                        <div className="mb-6">
                            <h3 className="text-2xl font-semibold mb-2" style={{ color: '#f6f3ee' }}>Contact Us</h3>
                        ...
                        <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                            ...
                            <div className="space-y-2">
                                ...
                                <textarea
                                    id="message"
                                    className="flex min-h-[120px] w-full rounded-md border border-white/20 bg-white/10 px-3 py-2 text-sm text-white placeholder:text-white/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-400 focus-visible:ring-offset-0"
